...
After installing dependencies, add platforms with:
...
Before a native build set `CAP_SERVER_URL` to your deployed HTTPS Next.js URL. Never put MongoDB, Auth.js or OpenAI secrets in the mobile bundle.
